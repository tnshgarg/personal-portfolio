    ...
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          ...
          I&apos;m an 18-year-old Software Engineer with 2 years of professional experience in Web Development, Mobile App Development, and working with startups in the FinTech industry.
        </p>
      </div>
